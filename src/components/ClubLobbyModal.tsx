...
import { Club, ClubMember, ClubMarathon, User } from '@/lib/types';
          ...
          <div className="flex-1 overflow-y-auto scrollbar-hide">
            ...
            <div className="p-8 sm:p-10 space-y-8 flex flex-col">
              ...
              <div className="grid grid-cols-2 gap-4 -mt-12 relative z-30">
                <button 
                  onClick={() => handleUserClick(club.ownerId)}
                  className="p-4 rounded-[24px] bg-white/80 backdrop-blur-xl shadow-xl border border-on-surface/5 flex items-center gap-3 text-left hover:scale-[1.02] active:scale-95 transition-all"
                >
              ...
              <div className="flex-1 overflow-y-auto space-y-3 px-2 pb-8 scrollbar-hide">
                 {members.map((m) => (
                   <button 
                    ...
                    className="flex items-center justify-between p-4 rounded-2xl bg-white/40 border border-on-surface/5 shadow-sm w-full text-left hover:bg-white/60 hover:scale-[1.01] active:scale-[0.98] transition-all"
                   >
