                    ...
                    {(['movie', 'book'] as ContentType[]).map((t) => (
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl text-[8px] font-black uppercase tracking-widest transition-all flex items-center gap-2 whitespace-nowrap ${
                          type === t ? 'bg-primary text-white shadow-lg shadow-primary/20' : 'bg-surface-container-low text-on-surface-muted hover:bg-on-surface/5'
                        }`}
                      >
                      ...
                      >
                        ...
                        <div className="flex gap-4 items-center">
                          ...
                          <button
                            ...
                            className="h-24 px-8 btn-premium rounded-2xl text-[10px] uppercase tracking-[0.2em] flex flex-col items-center justify-center gap-2"
                          >
                            {isSubmitting ? (
